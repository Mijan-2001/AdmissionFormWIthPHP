...
<body>
  <div class="container-fluid">
    ...
    if ($count == 0) {
      echo 'Registration number is missing or invalid.Kindly filup <a href="studentForm.php">admission form</a>..';
    } else {
    ?>
      <div class="row">
        <div class="col-sm-1">
        ...
        <div class="col-sm-10" style="border: 2px solid black; padding:10px;">
          ...
          ?>
            <div class="row">
              <div class="col-2">
                <img src="https://www.pust.ac.bd/includes/images/pust_logo.png?key=41" class="img-fluid">
              </div>
              <div class="col">
                <div class="main-heading">Pabna University of Science and Technology</div>
                <p class="sub-heading"> Ministry of Education (Govt. of Bangladesh )</p>
                <div class="address"> Dhaka - Pabna Hwy, Pabna 6600</div>
                <p class="email"> Email: registraroffice@pust.ac.bd , Website: https://www.pust.ac.bd/</p>
              </div>
              <div class="col-sm-12">
                <hr class="hrcls">
              </div>
