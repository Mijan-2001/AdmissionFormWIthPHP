...
<body>
  <div class="container" style="border:1px solid black; background-color:aliceblue;">
    <div class="row">
      <div class="col-sm-2">
      </div>
      <div class="col-sm-8" style="border: 2px solid black;padding:5px; text-align: center;margin-top:10px;">
        <h1>Pabna University of Science and Technology<br>Admission Form 2023</h1>
      </div>
      <div class="col-sm-2">
      </div>
    </div>
